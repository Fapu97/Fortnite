...
// BlueprintGeneratedClass TT_Commando_GoinCommando.TT_Commando_GoinCommando_C
// 0x0000 (0x0118 - 0x0118)
class UTT_Commando_GoinCommando_C : public UFortGameplayAbilityTooltip
{
public:

	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass TT_Commando_GoinCommando.TT_Commando_GoinCommando_C");
		return ptr;
	}
