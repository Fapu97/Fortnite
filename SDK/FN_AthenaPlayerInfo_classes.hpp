...
public:
	...
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass AthenaPlayerInfo.AthenaPlayerInfo_C");
		return ptr;
	}
	...
	void Destruct();
	void ExecuteUbergraph_AthenaPlayerInfo(int EntryPoint);
};
