...
struct FStruct_SurvivorScriptedAbilities
{
	...
	struct FGameplayTag                                NPC_Ability_NonAttack_RescueFalse_11_B549D5AB4CBCBCA2155C3FAA098A58D0;// 0x0020(0x0008) (CPF_Edit, CPF_BlueprintVisible)
	struct FGameplayTag                                NPC_Ability_NonAttack_LockInPlaceTrue_18_1FA6565D4BC9F11CB51AC584EFDE6999;// 0x0028(0x0008) (CPF_Edit, CPF_BlueprintVisible)
	struct FGameplayTag                                NPC_Ability_NonAttack_LockInPlaceFalse_20_B578575C4157F18CAD94EEBB4BA45E71;// 0x0030(0x0008) (CPF_Edit, CPF_BlueprintVisible)
	struct FGameplayTag                                NPC_Ability_NonAttack_RescueStart_28_F37EAFF4488E12ABFE11299818466044;// 0x0038(0x0008) (CPF_Edit, CPF_BlueprintVisible)
	struct FGameplayTag                                NPC_Ability_NonAttack_RescueFinish_29_7B19BD2348AA524234D34493C53321F3;// 0x0040(0x0008) (CPF_Edit, CPF_BlueprintVisible)
};
