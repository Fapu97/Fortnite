...
struct UMtxOffer_2_C_BndEvt__Purchase_Button_K2Node_ComponentBoundEvent_516_FortBaseButtonClicked__DelegateSignature_Params
{
	class UFortBaseButton*                             Button;                                                   // (CPF_Parm, CPF_ZeroConstructor, CPF_IsPlainOldData)
};

// Function MtxOffer_3.MtxOffer_2_C.Construct
struct UMtxOffer_2_C_Construct_Params
{
};
...
struct UMtxOffer_2_C_BndEvt__Purchase_Button_K2Node_ComponentBoundEvent_3_On_Mouse_Hovered_Changed__DelegateSignature_Params
{
...
struct UMtxOffer_2_C_BndEvt__IconTextButton_K2Node_ComponentBoundEvent_51_CommonButtonClicked__DelegateSignature_Params
{
	class UCommonButton*                               Button;                                                   // (CPF_Parm, CPF_ZeroConstructor, CPF_IsPlainOldData)
};

// Function MtxOffer_3.MtxOffer_2_C.ExecuteUbergraph_MtxOffer_3
struct UMtxOffer_2_C_ExecuteUbergraph_MtxOffer_3_Params
{
	int                                                EntryPoint;                                               // (CPF_Parm, CPF_ZeroConstructor, CPF_IsPlainOldData)
};

// Function MtxOffer_3.MtxOffer_2_C.MtxOfferMouseLeave_EventDispatcher__DelegateSignature
struct UMtxOffer_2_C_MtxOfferMouseLeave_EventDispatcher__DelegateSignature_Params
{
};

// Function MtxOffer_3.MtxOffer_2_C.MtxOfferMouseEnter_EventDispatcher__DelegateSignature
struct UMtxOffer_2_C_MtxOfferMouseEnter_EventDispatcher__DelegateSignature_Params
{
};

// Function MtxOffer_3.MtxOffer_2_C.BuyItem__DelegateSignature
struct UMtxOffer_2_C_BuyItem__DelegateSignature_Params
{
