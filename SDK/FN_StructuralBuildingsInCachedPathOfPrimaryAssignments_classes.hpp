...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass StructuralBuildingsInCachedPathOfPrimaryAssignments.StructuralBuildingsInCachedPathOfPrimaryAssignments_C");
		return ptr;
	}
