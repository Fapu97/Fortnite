...
public:
	...
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass ActiveModifiersPanelContent.ActiveModifiersPanelContent_C");
		return ptr;
	}
	...
	void Construct();
	void ExecuteUbergraph_ActiveModifiersPanelContent(int EntryPoint);
};
