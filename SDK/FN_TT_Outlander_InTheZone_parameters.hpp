...
// Function TT_Outlander_InTheZone.TT_Outlander_InTheZone_C.GetTextForTokenFromAbilityInstanceInternal
struct UTT_Outlander_InTheZone_C_GetTextForTokenFromAbilityInstanceInternal_Params
{
...
// Function TT_Outlander_InTheZone.TT_Outlander_InTheZone_C.InitializeAbilityInstanceInternal
struct UTT_Outlander_InTheZone_C_InitializeAbilityInstanceInternal_Params
{
	class UGameplayAbility**                           AbilityInstance;                                          // (CPF_ConstParm, CPF_Parm, CPF_ZeroConstructor, CPF_IsPlainOldData)
	class UFortTooltipContext**                        Context;                                                  // (CPF_ConstParm, CPF_Parm, CPF_ZeroConstructor, CPF_IsPlainOldData)
};
