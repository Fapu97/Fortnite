...
struct FAnimNode_AnimDynamics : public FAnimNode_SkeletalControlBase
{
	...
	unsigned char                                      UnknownData01[0x1];                                       // 0x0190(0x0001) UNKNOWN PROPERTY: EnumProperty AnimGraphRuntime.AnimNode_AnimDynamics.CollisionType
	...
	unsigned char                                      UnknownData02[0xC4];                                      // 0x01A4(0x00C4) MISSED OFFSET
};
...
struct FAnimNode_BoneDrivenController : public FAnimNode_SkeletalControlBase
{
	...
	unsigned char                                      UnknownData00[0x1];                                       // 0x00A8(0x0001) UNKNOWN PROPERTY: EnumProperty AnimGraphRuntime.AnimNode_BoneDrivenController.DestinationMode
	...
	unsigned char                                      UnknownData01[0x1];                                       // 0x00CE(0x0001) UNKNOWN PROPERTY: EnumProperty AnimGraphRuntime.AnimNode_BoneDrivenController.ModificationMode
};
...
struct FAnimNode_LookAt : public FAnimNode_SkeletalControlBase
{
	...
	unsigned char                                      UnknownData00[0x97];                                      // 0x00B9(0x0097) MISSED OFFSET
};
...
struct FAnimNode_SpringBone : public FAnimNode_SkeletalControlBase
{
	...
	unsigned char                                      UnknownData00[0x2D];                                      // 0x009B(0x002D) MISSED OFFSET
};
...
struct FAnimNode_Trail : public FAnimNode_SkeletalControlBase
{
	...
	unsigned char                                      UnknownData00[0x70];                                      // 0x0130(0x0070) MISSED OFFSET
};
