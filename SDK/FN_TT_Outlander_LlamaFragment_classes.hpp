...
// BlueprintGeneratedClass TT_Outlander_LlamaFragment.TT_Outlander_LlamaFragment_C
// 0x0000 (0x0118 - 0x0118)
class UTT_Outlander_LlamaFragment_C : public UFortGameplayAbilityTooltip
{
public:

	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass TT_Outlander_LlamaFragment.TT_Outlander_LlamaFragment_C");
		return ptr;
	}
