...
public:
	...
	unsigned char                                      UnknownData00[0x2C];                                      // 0x03D4(0x002C) MISSED OFFSET
...
public:
	...
	unsigned char                                      UnknownData00[0x1];                                       // 0x00E4(0x0001) UNKNOWN PROPERTY: EnumProperty AIModule.EnvQueryTest.NormalizationType
	...
	unsigned char                                      UnknownData01[0xF];                                       // 0x01A9(0x000F) MISSED OFFSET
...
public:
	...
	unsigned char                                      UnknownData01[0xE0];                                      // 0x0040(0x00E0) MISSED OFFSET
...
public:
	...
	unsigned char                                      UnknownData00[0x1];                                       // 0x00C8(0x0001) UNKNOWN PROPERTY: EnumProperty AIModule.BTDecorator_IsAtLocation.GeometricDistanceType
...
public:
	...
	unsigned char                                      UnknownData00[0x40];                                      // 0x0140(0x0040) MISSED OFFSET
...
public:
	...
	unsigned char                                      UnknownData02[0x2F];                                      // 0x07E1(0x002F) MISSED OFFSET
