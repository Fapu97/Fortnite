...
struct UCollectionBookHelp_C_BndEvt__ButtonClose_K2Node_ComponentBoundEvent_28_CommonButtonClicked__DelegateSignature_Params
{
	class UCommonButton*                               Button;                                                   // (CPF_Parm, CPF_ZeroConstructor, CPF_IsPlainOldData)
};

// Function CollectionBookHelp.CollectionBookHelp_C.ExecuteUbergraph_CollectionBookHelp
struct UCollectionBookHelp_C_ExecuteUbergraph_CollectionBookHelp_Params
{
