...
public:
	...
	struct FScriptDelegate                             ToolTipTextDelegate;                                      // 0x0068(0x0014) (CPF_ZeroConstructor, CPF_InstancedReference)
	...
	struct FScriptDelegate                             ToolTipWidgetDelegate;                                    // 0x0080(0x0014) (CPF_ZeroConstructor, CPF_InstancedReference)
	unsigned char                                      UnknownData00[0x1];                                       // 0x0090(0x0001) UNKNOWN PROPERTY: EnumProperty UMG.Widget.Visiblity
	unsigned char                                      UnknownData01[0x1];                                       // 0x0091(0x0001) UNKNOWN PROPERTY: EnumProperty UMG.Widget.Visibility
	struct FScriptDelegate                             VisibilityDelegate;                                       // 0x0098(0x0014) (CPF_ZeroConstructor, CPF_InstancedReference)
...
public:
	...
	unsigned char                                      UnknownData01[0x50];                                      // 0x01E0(0x0050) MISSED OFFSET
...
public:
	...
	unsigned char                                      UnknownData00[0x17];                                      // 0x01C1(0x0017) MISSED OFFSET
...
public:
	...
	struct FScriptDelegate                             OnGenerateWidgetEvent;                                    // 0x0D28(0x0014) (CPF_Edit, CPF_ZeroConstructor, CPF_InstancedReference)
	...
	unsigned char                                      UnknownData00[0x40];                                      // 0x0D58(0x0040) MISSED OFFSET
...
public:
	...
	unsigned char                                      UnknownData00[0x1];                                       // 0x0128(0x0001) UNKNOWN PROPERTY: EnumProperty UMG.TextLayoutWidget.WrappingPolicy
...
public:
	...
	struct FScriptDelegate                             TextDelegate;                                             // 0x0130(0x0014) (CPF_ZeroConstructor, CPF_InstancedReference)
...
public:
	...
	struct FScriptDelegate                             HintTextDelegate;                                         // 0x09D0(0x0014) (CPF_ZeroConstructor, CPF_InstancedReference)
...
public:
	...
	struct FScriptDelegate                             BrushDelegate;                                            // 0x01B0(0x0014) (CPF_ZeroConstructor, CPF_InstancedReference)
	struct FLinearColor                                ColorAndOpacity;                                          // 0x01C0(0x0010) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_IsPlainOldData)
	struct FScriptDelegate                             ColorAndOpacityDelegate;                                  // 0x01D0(0x0014) (CPF_ZeroConstructor, CPF_InstancedReference)
	struct FScriptDelegate                             OnMouseButtonDownEvent;                                   // 0x01E0(0x0014) (CPF_Edit, CPF_ZeroConstructor, CPF_InstancedReference)
...
public:
	...
	struct FScriptDelegate                             BackgroundDelegate;                                       // 0x01F8(0x0014) (CPF_ZeroConstructor, CPF_InstancedReference)
	struct FLinearColor                                BrushColor;                                               // 0x0208(0x0010) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_IsPlainOldData)
	struct FScriptDelegate                             BrushColorDelegate;                                       // 0x0218(0x0014) (CPF_ZeroConstructor, CPF_InstancedReference)
	...
	struct FScriptDelegate                             OnMouseButtonDownEvent;                                   // 0x0238(0x0014) (CPF_Edit, CPF_ZeroConstructor, CPF_InstancedReference)
	struct FScriptDelegate                             OnMouseButtonUpEvent;                                     // 0x0248(0x0014) (CPF_Edit, CPF_ZeroConstructor, CPF_InstancedReference)
	struct FScriptDelegate                             OnMouseMoveEvent;                                         // 0x0258(0x0014) (CPF_Edit, CPF_ZeroConstructor, CPF_InstancedReference)
	struct FScriptDelegate                             OnMouseDoubleClickEvent;                                  // 0x0268(0x0014) (CPF_Edit, CPF_ZeroConstructor, CPF_InstancedReference)
...
public:
	...
	struct FScriptDelegate                             CheckedStateDelegate;                                     // 0x0138(0x0014) (CPF_ZeroConstructor, CPF_InstancedReference)
	...
	unsigned char                                      UnknownData01[0x10];                                      // 0x07D0(0x0010) MISSED OFFSET
...
public:
	...
	unsigned char                                      UnknownData02[0x1];                                       // 0x08AD(0x0001) UNKNOWN PROPERTY: EnumProperty UMG.ScrollBox.NavigationDestination
	...
	unsigned char                                      UnknownData03[0x14];                                      // 0x08B4(0x0014) MISSED OFFSET
...
public:
	...
	struct FScriptDelegate                             PercentDelegate;                                          // 0x02F8(0x0014) (CPF_ZeroConstructor, CPF_InstancedReference)
	...
	struct FScriptDelegate                             FillColorAndOpacityDelegate;                              // 0x0318(0x0014) (CPF_ZeroConstructor, CPF_InstancedReference)
...
public:
	...
	unsigned char                                      UnknownData00[0x14];                                      // 0x0644(0x0014) MISSED OFFSET
...
public:
	...
	struct FScriptDelegate                             ValueDelegate;                                            // 0x0120(0x0014) (CPF_ZeroConstructor, CPF_InstancedReference)
...
public:
	...
	TArray<class UObject*>                             Items;                                                    // 0x0120(0x0010) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor)
	TEnumAsByte<ESelectionMode>                        SelectionMode;                                            // 0x0130(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	struct FScriptDelegate                             OnGenerateTileEvent;                                      // 0x0138(0x0014) (CPF_Edit, CPF_ZeroConstructor, CPF_InstancedReference)
	unsigned char                                      UnknownData00[0x10];                                      // 0x0148(0x0010) MISSED OFFSET
...
public:
	...
	struct FScriptDelegate                             HintTextDelegate;                                         // 0x0170(0x0014) (CPF_ZeroConstructor, CPF_InstancedReference)
...
public:
	...
	unsigned char                                      UnknownData00[0x10];                                      // 0x0CC0(0x0010) MISSED OFFSET
...
public:
	struct FText                                       Text;                                                     // 0x0140(0x0018) (CPF_Edit)
	struct FScriptDelegate                             TextDelegate;                                             // 0x0158(0x0014) (CPF_ZeroConstructor, CPF_InstancedReference)
...
public:
	...
	struct FScriptDelegate                             ColorAndOpacityDelegate;                                  // 0x0190(0x0014) (CPF_ZeroConstructor, CPF_InstancedReference)
	...
	struct FScriptDelegate                             ShadowColorAndOpacityDelegate;                            // 0x0220(0x0014) (CPF_ZeroConstructor, CPF_InstancedReference)
	...
	unsigned char                                      UnknownData00[0x13];                                      // 0x0235(0x0013) MISSED OFFSET
...
public:
	...
	unsigned char                                      UnknownData01[0x1];                                       // 0x07E4(0x0001) UNKNOWN PROPERTY: EnumProperty UMG.WidgetComponent.BlendMode
	...
	unsigned char                                      UnknownData02[0x20];                                      // 0x07F0(0x0020) MISSED OFFSET
	...
	unsigned char                                      UnknownData03[0x1];                                       // 0x086C(0x0001) UNKNOWN PROPERTY: EnumProperty UMG.WidgetComponent.GeometryMode
	float                                              CylinderArcAngle;                                         // 0x0870(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      UnknownData04[0x3C];                                      // 0x0874(0x003C) MISSED OFFSET
...
public:
	...
	unsigned char                                      UnknownData01[0x1];                                       // 0x02C0(0x0001) UNKNOWN PROPERTY: EnumProperty UMG.WidgetInteractionComponent.InteractionSource
	...
	unsigned char                                      UnknownData02[0x7C];                                      // 0x02D4(0x007C) MISSED OFFSET
