...
struct FGrassVariety
{
	...
	unsigned char                                      UnknownData00[0x1];                                       // 0x0020(0x0001) UNKNOWN PROPERTY: EnumProperty Landscape.GrassVariety.Scaling
	...
	unsigned char                                      bReceivesDecals : 1;                                      // 0x0040(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
};
...
struct FLayerBlendInput
{
	...
	struct FVector                                     ConstLayerInput;                                          // 0x0084(0x000C) (CPF_Edit, CPF_IsPlainOldData)
