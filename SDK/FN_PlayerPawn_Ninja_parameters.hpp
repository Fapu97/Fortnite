...
{
	TEnumAsByte<EFortCustomPartType>                   PartType;                                                 // (CPF_Parm, CPF_ZeroConstructor, CPF_IsPlainOldData)
	class USkeletalMeshComponent*                      Shadow_Mesh_Component;                                    // (CPF_Parm, CPF_OutParm, CPF_ZeroConstructor, CPF_ReferenceParm, CPF_IsPlainOldData)
	TArray<class UMaterialInterface*>                  Character_Body_Part_MID_Array;                            // (CPF_Parm, CPF_OutParm, CPF_ZeroConstructor, CPF_ReferenceParm)
	TArray<class UMaterialInstanceDynamic*>            Empty_Translucent_Shadow_Stance_Output_MID_Array;         // (CPF_Parm, CPF_OutParm, CPF_ZeroConstructor, CPF_ReferenceParm)
	bool                                               Set;                                                      // (CPF_Parm, CPF_OutParm, CPF_ZeroConstructor, CPF_IsPlainOldData)
};
...
{
	bool                                               NewPierceValue;                                           // (CPF_Parm, CPF_ZeroConstructor, CPF_IsPlainOldData)
};
...
{
	float                                              AoeCloudTimeToLive;                                       // (CPF_Parm, CPF_ZeroConstructor, CPF_IsPlainOldData)
	float                                              MontageLength;                                            // (CPF_Parm, CPF_ZeroConstructor, CPF_IsPlainOldData)
};
