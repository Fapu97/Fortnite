...
{
public:
	struct FBlackboardKeySelector                      ActorKeyToTest;                                           // 0x00A0(0x0028) (CPF_Edit, CPF_BlueprintVisible)
	struct FBlackboardKeySelector                      TakerAirborneKeyToMoveTo;                                 // 0x00C8(0x0028) (CPF_Edit, CPF_BlueprintVisible)
