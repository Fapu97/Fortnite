...
struct FPurchaseFlowItem
{
	...
	struct FString                                     EntitlementId;                                            // 0x0010(0x0010) (CPF_ZeroConstructor)
	struct FString                                     ValidationInfo;                                           // 0x0020(0x0010) (CPF_ZeroConstructor)
};
...
{
	struct FString                                     TransactionId;                                            // 0x0000(0x0010) (CPF_ZeroConstructor)
	struct FString                                     TransactionState;                                         // 0x0010(0x0010) (CPF_ZeroConstructor)
	TArray<struct FPurchaseFlowOffer>                  Offers;                                                   // 0x0020(0x0010) (CPF_ZeroConstructor)
};
