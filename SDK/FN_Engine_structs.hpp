...
enum class EParticleSystemLODMethod
{
...
enum class EParticleReplayState
{
	PRS_Disabled                   = 0,
	PRS_Capturing                  = 1,
	PRS_Replaying                  = 2,
...
enum class ESkeletalMeshOptimizationType
{
...
enum class ESkeletalMeshOptimizationImportance
{
	SMOI_Off                       = 0,
	SMOI_Lowest                    = 1,
	SMOI_Low                       = 2,
...
enum class EAnimationKeyFormat
{
...
enum class EAnimationCompressionFormat
{
	ACF_None                       = 0,
	ACF_Float96NoW                 = 1,
	ACF_Fixed48NoW                 = 2,
...
enum class EFNavigationSystemRunMode
{
...
enum class EDistributionParamMode
{
	DPM_Normal                     = 0,
	DPM_Abs                        = 1,
	DPM_Direct                     = 2,
...
enum class EBeam2SourceTargetTangentMethod
{
	PEB2STTM_Direct                = 0,
	PEB2STTM_UserSet               = 1,
...
enum class EBeam2SourceTargetMethod
{
	PEB2STM_Default                = 0,
	PEB2STM_UserSet                = 1,
	PEB2STM_Emitter                = 2,
...
enum class ECylinderHeightAxis
{
...
enum class EModulationParamMode
{
	MPM_Normal                     = 0,
	MPM_Abs                        = 1,
	MPM_Direct                     = 2,
...
enum class EDrawDebugItemType
{
	...
	EDrawDebugItemType__EDrawDebugItemType_MAX = 4
};


// Enum Engine.AnimPhysCollisionType
enum class EAnimPhysCollisionType
{
...
struct FBodyInstance
{
	...
	unsigned char                                      UnknownData01[0x1];                                       // 0x0034(0x0001) UNKNOWN PROPERTY: EnumProperty Engine.BodyInstance.SleepFamily
	...
	unsigned char                                      UnknownData03[0x13];                                      // 0x00B5(0x0013) MISSED OFFSET
	...
	unsigned char                                      UnknownData04[0x28];                                      // 0x00F0(0x0028) MISSED OFFSET
	...
	unsigned char                                      UnknownData05[0xF4];                                      // 0x012C(0x00F4) MISSED OFFSET
};
...
struct FMaterialProxySettings
{
	...
	unsigned char                                      bNormalMap : 1;                                           // 0x0010(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      bMetallicMap : 1;                                         // 0x0011(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	float                                              MetallicConstant;                                         // 0x0014(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      bRoughnessMap : 1;                                        // 0x0018(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	float                                              RoughnessConstant;                                        // 0x001C(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      bSpecularMap : 1;                                         // 0x0020(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	float                                              SpecularConstant;                                         // 0x0024(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      bEmissiveMap : 1;                                         // 0x0028(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      bOpacityMap : 1;                                          // 0x0029(0x0001) (CPF_ZeroConstructor, CPF_IsPlainOldData)
...
struct FMeshProxySettings
{
	...
	unsigned char                                      bExportNormalMap : 1;                                     // 0x0074(0x0001) (CPF_ZeroConstructor, CPF_Deprecated, CPF_IsPlainOldData)
	unsigned char                                      bExportMetallicMap : 1;                                   // 0x0075(0x0001) (CPF_ZeroConstructor, CPF_Deprecated, CPF_IsPlainOldData)
	unsigned char                                      bExportRoughnessMap : 1;                                  // 0x0076(0x0001) (CPF_ZeroConstructor, CPF_Deprecated, CPF_IsPlainOldData)
	unsigned char                                      bExportSpecularMap : 1;                                   // 0x0077(0x0001) (CPF_ZeroConstructor, CPF_Deprecated, CPF_IsPlainOldData)
	struct FMaterialSimplificationSettings             Material;                                                 // 0x0078(0x0044) (CPF_Deprecated)
	unsigned char                                      bCalculateCorrectLODModel : 1;                            // 0x00BC(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	...
	unsigned char                                      bRecalculateNormals : 1;                                  // 0x00CC(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      bBakeVertexData : 1;                                      // 0x00CD(0x0001) (CPF_ZeroConstructor, CPF_Deprecated, CPF_IsPlainOldData)
	unsigned char                                      bUseLandscapeCulling : 1;                                 // 0x00CE(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	...
	unsigned char                                      bAllowAdjacency : 1;                                      // 0x00D0(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      bAllowDistanceField : 1;                                  // 0x00D1(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
};
...
struct FMeshMergingSettings
{
	...
	unsigned char                                      bMergeMaterials : 1;                                      // 0x000B(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	struct FMaterialProxySettings                      MaterialSettings;                                         // 0x000C(0x0068) (CPF_Edit)
	unsigned char                                      bBakeVertexDataToMesh : 1;                                // 0x0074(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      bUseVertexDataForBakingMaterial : 1;                      // 0x0075(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      bUseTextureBinning : 1;                                   // 0x0076(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      bCalculateCorrectLODModel : 1;                            // 0x0077(0x0001) (CPF_ZeroConstructor, CPF_Deprecated, CPF_IsPlainOldData)
	unsigned char                                      UnknownData00[0x1];                                       // 0x0078(0x0001) UNKNOWN PROPERTY: EnumProperty Engine.MeshMergingSettings.LODSelectionType
	...
	unsigned char                                      bUseLandscapeCulling : 1;                                 // 0x0084(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      bExportNormalMap : 1;                                     // 0x0085(0x0001) (CPF_ZeroConstructor, CPF_Deprecated, CPF_IsPlainOldData)
	unsigned char                                      bExportMetallicMap : 1;                                   // 0x0086(0x0001) (CPF_ZeroConstructor, CPF_Deprecated, CPF_IsPlainOldData)
	unsigned char                                      bExportRoughnessMap : 1;                                  // 0x0087(0x0001) (CPF_ZeroConstructor, CPF_Deprecated, CPF_IsPlainOldData)
	unsigned char                                      bExportSpecularMap : 1;                                   // 0x0088(0x0001) (CPF_ZeroConstructor, CPF_Deprecated, CPF_IsPlainOldData)
...
struct FHierarchicalSimplification
{
	...
	unsigned char                                      bOnlyGenerateClustersForVolumes : 1;                      // 0x0180(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
};
...
struct FAlphaBlend
{
	unsigned char                                      UnknownData00[0x1];                                       // 0x0000(0x0001) UNKNOWN PROPERTY: EnumProperty Engine.AlphaBlend.BlendOption
...
{
	unsigned char                                      UnknownData00[0x8];                                       // 0x0000(0x0008) MISSED OFFSET
	unsigned char                                      UnknownData01[0x1];                                       // 0x0000(0x0001) UNKNOWN PROPERTY: EnumProperty Engine.BaseAttenuationSettings.DistanceAlgorithm
...
struct FConstraintInstance
{
	...
	unsigned char                                      UnknownData01[0x60];                                      // 0x0190(0x0060) MISSED OFFSET
};
...
struct FAnimationTransitionBetweenStates : public FAnimationStateBase
{
	...
	unsigned char                                      UnknownData00[0x1];                                       // 0x0020(0x0001) UNKNOWN PROPERTY: EnumProperty Engine.AnimationTransitionBetweenStates.BlendMode
...
struct FPrimaryAssetRules
{
	...
	unsigned char                                      bApplyRecursively : 1;                                    // 0x0004(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	int                                                ChunkId;                                                  // 0x0008(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      UnknownData00[0x1];                                       // 0x000C(0x0001) UNKNOWN PROPERTY: EnumProperty Engine.PrimaryAssetRules.CookRule
};
...
struct FPrimaryAssetTypeInfo
{
	...
	unsigned char                                      bIsEditorOnly : 1;                                        // 0x0031(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	...
	unsigned char                                      bIsDynamicAsset : 1;                                      // 0x0078(0x0001) (CPF_ZeroConstructor, CPF_Transient, CPF_IsPlainOldData)
...
struct FFormatArgumentData
{
	...
	unsigned char                                      UnknownData00[0x1];                                       // 0x0038(0x0001) UNKNOWN PROPERTY: EnumProperty Engine.FormatArgumentData.ArgumentValueGender
};
...
struct FExposedValueCopyRecord
{
	...
	unsigned char                                      UnknownData00[0x1];                                       // 0x0031(0x0001) UNKNOWN PROPERTY: EnumProperty Engine.ExposedValueCopyRecord.PostCopyOperation
...
struct FPoseSnapshot
{
	...
	unsigned char                                      bIsValid : 1;                                             // 0x0030(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
};
...
struct FAnimUpdateRateParameters
{
	...
	unsigned char                                      UnknownData00[0x1];                                       // 0x0084(0x0001) UNKNOWN PROPERTY: EnumProperty Engine.AnimUpdateRateParameters.ShiftBucket
};
...
struct FLevelSimplificationDetails
{
	...
	unsigned char                                      bOverrideLandscapeExportLOD : 1;                          // 0x00B4(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	...
	unsigned char                                      bBakeFoliageToLandscape : 1;                              // 0x0168(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      bBakeGrassToLandscape : 1;                                // 0x0169(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      bGenerateMeshNormalMap : 1;                               // 0x016A(0x0001) (CPF_ZeroConstructor, CPF_Deprecated, CPF_IsPlainOldData)
	unsigned char                                      bGenerateMeshMetallicMap : 1;                             // 0x016B(0x0001) (CPF_ZeroConstructor, CPF_Deprecated, CPF_IsPlainOldData)
	unsigned char                                      bGenerateMeshRoughnessMap : 1;                            // 0x016C(0x0001) (CPF_ZeroConstructor, CPF_Deprecated, CPF_IsPlainOldData)
	unsigned char                                      bGenerateMeshSpecularMap : 1;                             // 0x016D(0x0001) (CPF_ZeroConstructor, CPF_Deprecated, CPF_IsPlainOldData)
	unsigned char                                      bGenerateLandscapeNormalMap : 1;                          // 0x016E(0x0001) (CPF_ZeroConstructor, CPF_Deprecated, CPF_IsPlainOldData)
	unsigned char                                      bGenerateLandscapeMetallicMap : 1;                        // 0x016F(0x0001) (CPF_ZeroConstructor, CPF_Deprecated, CPF_IsPlainOldData)
	unsigned char                                      bGenerateLandscapeRoughnessMap : 1;                       // 0x0170(0x0001) (CPF_ZeroConstructor, CPF_Deprecated, CPF_IsPlainOldData)
	unsigned char                                      bGenerateLandscapeSpecularMap : 1;                        // 0x0171(0x0001) (CPF_ZeroConstructor, CPF_Deprecated, CPF_IsPlainOldData)
};
...
struct FMeshReductionSettings
{
	...
	unsigned char                                      bRecalculateNormals : 1;                                  // 0x0017(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	int                                                BaseLODModel;                                             // 0x0018(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      bGenerateUniqueLightmapUVs : 1;                           // 0x001C(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      bKeepSymmetry : 1;                                        // 0x001D(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      bVisibilityAided : 1;                                     // 0x001E(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      bCullOccluded : 1;                                        // 0x001F(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
...
{
	unsigned char                                      UnknownData00[0x1];                                       // 0x0000(0x0001) UNKNOWN PROPERTY: EnumProperty Engine.RootMotionFinishVelocitySettings.Mode
...
struct FRootMotionSource
{
	...
	unsigned char                                      UnknownData01[0x1];                                       // 0x0014(0x0001) UNKNOWN PROPERTY: EnumProperty Engine.RootMotionSource.AccumulateMode
...
struct FRootMotionSource_JumpForce : public FRootMotionSource
{
	...
	unsigned char                                      bDisableTimeout : 1;                                      // 0x00AC(0x0001) (CPF_ZeroConstructor, CPF_IsPlainOldData)
...
struct FRootMotionSource_MoveToDynamicForce : public FRootMotionSource
{
	...
	unsigned char                                      bRestrictSpeedToExpected : 1;                             // 0x00BC(0x0001) (CPF_ZeroConstructor, CPF_IsPlainOldData)
...
struct FRootMotionSource_MoveToForce : public FRootMotionSource
{
	...
	unsigned char                                      bRestrictSpeedToExpected : 1;                             // 0x00B0(0x0001) (CPF_ZeroConstructor, CPF_IsPlainOldData)
...
struct FRootMotionSource_RadialForce : public FRootMotionSource
{
	...
	unsigned char                                      bIsPush : 1;                                              // 0x00B8(0x0001) (CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      bNoZForce : 1;                                            // 0x00B9(0x0001) (CPF_ZeroConstructor, CPF_IsPlainOldData)
	...
	unsigned char                                      bUseFixedWorldDirection : 1;                              // 0x00D0(0x0001) (CPF_ZeroConstructor, CPF_IsPlainOldData)
...
struct FAnimMontageInstance
{
	...
	unsigned char                                      UnknownData04[0x2C];                                      // 0x0164(0x002C) MISSED OFFSET
};
...
{
	unsigned char                                      ServerOnlyPlatform : 1;                                   // 0x0000(0x0001) (CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      ClientOnlyPlatform : 1;                                   // 0x0001(0x0001) (CPF_ZeroConstructor, CPF_IsPlainOldData)
};
...
struct FPredictProjectilePathParams
{
	...
	unsigned char                                      bTraceWithCollision : 1;                                  // 0x0018(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
	...
	unsigned char                                      bTraceWithChannel : 1;                                    // 0x0024(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
	...
	unsigned char                                      bTraceComplex : 1;                                        // 0x0058(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
};
...
struct FQueuedDrawDebugItem
{
	...
	unsigned char                                      bPersistentLines : 1;                                     // 0x0038(0x0001) (CPF_ZeroConstructor, CPF_Transient, CPF_IsPlainOldData)
