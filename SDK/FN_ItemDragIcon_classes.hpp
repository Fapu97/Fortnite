...
public:
	...
	class UTexture2D*                                  IconTexture;                                              // 0x0250(0x0008) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)

	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass ItemDragIcon.ItemDragIcon_C");
		return ptr;
	}
