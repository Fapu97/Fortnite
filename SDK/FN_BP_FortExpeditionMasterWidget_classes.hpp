...
public:
	...
	unsigned char                                      UnknownData00[0x1];                                       // 0x0528(0x0001) UNKNOWN PROPERTY: EnumProperty BP_FortExpeditionMasterWidget.BP_FortExpeditionMasterWidget_C.ExpeditionListSortType
	unsigned char                                      UnknownData01[0x1];                                       // 0x0529(0x0001) UNKNOWN PROPERTY: EnumProperty BP_FortExpeditionMasterWidget.BP_FortExpeditionMasterWidget_C.ExpeditionListSortBegin
	unsigned char                                      UnknownData02[0x1];                                       // 0x052A(0x0001) UNKNOWN PROPERTY: EnumProperty BP_FortExpeditionMasterWidget.BP_FortExpeditionMasterWidget_C.ExpeditionListSortEnd
