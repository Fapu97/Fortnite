...
{
	bool                                               bPickingTile;                                             // (CPF_Parm, CPF_ZeroConstructor, CPF_IsPlainOldData)
};
...
{
	bool                                               Left;                                                     // (CPF_Parm, CPF_OutParm, CPF_ZeroConstructor, CPF_IsPlainOldData)
};
...
{
	struct FName                                       CurrentCategory;                                          // (CPF_Parm, CPF_ZeroConstructor, CPF_IsPlainOldData)
};
...
struct UBP_LocalPlayerBannerEditor_C_BannerTileBangUpdated_Event_1_Params
{
};
