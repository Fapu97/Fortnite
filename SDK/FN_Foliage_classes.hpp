...
public:
	...
	struct FScriptMulticastDelegate                    OnInstanceTakeRadialDamage;                               // 0x09A8(0x0010) (CPF_ZeroConstructor, CPF_InstancedReference, CPF_BlueprintAssignable)
...
public:
	...
	struct FBodyInstance                               BodyInstance;                                             // 0x0140(0x0220) (CPF_Edit)
	TEnumAsByte<EHasCustomNavigableGeometry>           CustomNavigableGeometry;                                  // 0x0360(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	struct FLightingChannels                           LightingChannels;                                         // 0x0361(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly)
	float                                              CollisionRadius;                                          // 0x0364(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	float                                              ShadeRadius;                                              // 0x0368(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	int                                                NumSteps;                                                 // 0x036C(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	float                                              InitialSeedDensity;                                       // 0x0370(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	float                                              AverageSpreadDistance;                                    // 0x0374(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	float                                              SpreadVariance;                                           // 0x0378(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	int                                                SeedsPerStep;                                             // 0x037C(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	int                                                DistributionSeed;                                         // 0x0380(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	float                                              MaxInitialSeedOffset;                                     // 0x0384(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      bCanGrowInShade : 1;                                      // 0x0388(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      bSpawnsInShade : 1;                                       // 0x0389(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	float                                              MaxInitialAge;                                            // 0x038C(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	float                                              MaxAge;                                                   // 0x0390(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	float                                              OverlapPriority;                                          // 0x0394(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	struct FFloatInterval                              ProceduralScale;                                          // 0x0398(0x0008) (CPF_Edit)
	struct FRuntimeFloatCurve                          ScaleCurve;                                               // 0x03A0(0x0078) (CPF_Edit)
	int                                                ChangeCount;                                              // 0x0418(0x0004) (CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      ReapplyDensity : 1;                                       // 0x041C(0x0001) (CPF_Edit, CPF_DisableEditOnInstance)
	unsigned char                                      ReapplyRadius : 1;                                        // 0x041C(0x0001) (CPF_Edit, CPF_DisableEditOnInstance)
	unsigned char                                      ReapplyAlignToNormal : 1;                                 // 0x041C(0x0001) (CPF_Edit, CPF_DisableEditOnInstance)
	unsigned char                                      ReapplyRandomYaw : 1;                                     // 0x041C(0x0001) (CPF_Edit, CPF_DisableEditOnInstance)
	unsigned char                                      ReapplyScaling : 1;                                       // 0x041C(0x0001) (CPF_Edit, CPF_DisableEditOnInstance)
	unsigned char                                      ReapplyScaleX : 1;                                        // 0x041C(0x0001) (CPF_Edit, CPF_DisableEditOnInstance)
	unsigned char                                      ReapplyScaleY : 1;                                        // 0x041C(0x0001) (CPF_Edit, CPF_DisableEditOnInstance)
	unsigned char                                      ReapplyScaleZ : 1;                                        // 0x041C(0x0001) (CPF_Edit, CPF_DisableEditOnInstance)
	unsigned char                                      ReapplyRandomPitchAngle : 1;                              // 0x041D(0x0001) (CPF_Edit, CPF_DisableEditOnInstance)
	unsigned char                                      ReapplyGroundSlope : 1;                                   // 0x041D(0x0001) (CPF_Edit, CPF_DisableEditOnInstance)
	unsigned char                                      ReapplyHeight : 1;                                        // 0x041D(0x0001) (CPF_Edit, CPF_DisableEditOnInstance)
	unsigned char                                      ReapplyLandscapeLayers : 1;                               // 0x041D(0x0001) (CPF_Edit, CPF_DisableEditOnInstance)
	unsigned char                                      ReapplyZOffset : 1;                                       // 0x041D(0x0001) (CPF_Edit, CPF_DisableEditOnInstance)
	unsigned char                                      ReapplyCollisionWithWorld : 1;                            // 0x041D(0x0001) (CPF_Edit, CPF_DisableEditOnInstance)
	unsigned char                                      ReapplyVertexColorMask : 1;                               // 0x041D(0x0001) (CPF_Edit, CPF_DisableEditOnInstance)
	unsigned char                                      bEnableDensityScaling : 1;                                // 0x041D(0x0001) (CPF_Edit)
...
{
public:
	class UStaticMesh*                                 Mesh;                                                     // 0x0420(0x0008) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	TArray<class UMaterialInterface*>                  OverrideMaterials;                                        // 0x0428(0x0010) (CPF_Edit, CPF_ZeroConstructor)
	class UClass*                                      ComponentClass;                                           // 0x0438(0x0008) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
...
public:
	...
	struct FVector                                     TouchingActorEntryPosition;                               // 0x03A0(0x000C) (CPF_Transient, CPF_IsPlainOldData)
	struct FVector                                     FoliageVelocity;                                          // 0x03AC(0x000C) (CPF_Transient, CPF_IsPlainOldData)
	struct FVector                                     FoliageForce;                                             // 0x03B8(0x000C) (CPF_Transient, CPF_IsPlainOldData)
	struct FVector                                     FoliagePosition;                                          // 0x03C4(0x000C) (CPF_Transient, CPF_IsPlainOldData)
	float                                              FoliageDamageImpulseScale;                                // 0x03D0(0x0004) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
	float                                              FoliageTouchImpulseScale;                                 // 0x03D4(0x0004) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
	float                                              FoliageStiffness;                                         // 0x03D8(0x0004) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
	float                                              FoliageStiffnessQuadratic;                                // 0x03DC(0x0004) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
	float                                              FoliageDamping;                                           // 0x03E0(0x0004) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
	float                                              MaxDamageImpulse;                                         // 0x03E4(0x0004) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
	float                                              MaxTouchImpulse;                                          // 0x03E8(0x0004) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
	float                                              MaxForce;                                                 // 0x03EC(0x0004) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
	float                                              Mass;                                                     // 0x03F0(0x0004) (CPF_ZeroConstructor, CPF_IsPlainOldData)
...
{
public:
	class AProceduralFoliageVolume*                    ProceduralFoliageVolume;                                  // 0x03C0(0x0008) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
...
{
public:
	class UProceduralFoliageComponent*                 ProceduralComponent;                                      // 0x03C0(0x0008) (CPF_Edit, CPF_BlueprintVisible, CPF_ExportObject, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_EditConst, CPF_InstancedReference, CPF_IsPlainOldData)
