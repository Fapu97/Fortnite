...
// BlueprintGeneratedClass TT_Constructor_BASE.TT_Constructor_BASE_C
// 0x0000 (0x0118 - 0x0118)
class UTT_Constructor_BASE_C : public UFortGameplayAbilityTooltip
{
public:

	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass TT_Constructor_BASE.TT_Constructor_BASE_C");
		return ptr;
	}
