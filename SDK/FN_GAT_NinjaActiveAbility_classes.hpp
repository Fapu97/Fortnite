...
public:
	...
	class APlayerPawn_Ninja_C*                         NinjaPlayerPawn;                                          // 0x0B00(0x0008) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_DisableEditOnTemplate, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass GAT_NinjaActiveAbility.GAT_NinjaActiveAbility_C");
		return ptr;
	}


	void K2_ActivateAbility();
	void ExecuteUbergraph_GAT_NinjaActiveAbility(int EntryPoint);
};
