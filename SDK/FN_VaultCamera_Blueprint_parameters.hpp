...
struct AVaultCamera_Blueprint_C_InpActEvt_RightMouseButton_K2Node_InputKeyEvent_8_Params
{
...
struct AVaultCamera_Blueprint_C_InpActEvt_LeftMouseButton_K2Node_InputKeyEvent_6_Params
{
	struct FKey                                        Key;                                                      // (CPF_Parm)
};
