...
// BlueprintGeneratedClass TT_Outlander_InTheZone.TT_Outlander_InTheZone_C
// 0x0000 (0x0118 - 0x0118)
class UTT_Outlander_InTheZone_C : public UFortGameplayAbilityTooltip
{
public:

	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass TT_Outlander_InTheZone.TT_Outlander_InTheZone_C");
		return ptr;
	}
