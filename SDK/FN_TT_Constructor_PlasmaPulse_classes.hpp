...
// BlueprintGeneratedClass TT_Constructor_PlasmaPulse.TT_Constructor_PlasmaPulse_C
// 0x0000 (0x0118 - 0x0118)
class UTT_Constructor_PlasmaPulse_C : public UFortGameplayAbilityTooltip
{
public:

	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass TT_Constructor_PlasmaPulse.TT_Constructor_PlasmaPulse_C");
		return ptr;
	}
