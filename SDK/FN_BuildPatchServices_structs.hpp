...
enum class EManifestFileHeader
{
...
struct FFileManifestData
{
	...
	unsigned char                                      bIsUnixExecutable : 1;                                    // 0x0048(0x0001) (CPF_ZeroConstructor, CPF_IsPlainOldData)
	struct FString                                     SymlinkTarget;                                            // 0x0050(0x0010) (CPF_ZeroConstructor)
	unsigned char                                      bIsReadOnly : 1;                                          // 0x0060(0x0001) (CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      bIsCompressed : 1;                                        // 0x0061(0x0001) (CPF_ZeroConstructor, CPF_IsPlainOldData)
