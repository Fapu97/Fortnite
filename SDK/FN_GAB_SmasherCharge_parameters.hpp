...
{
	bool                                               Standing_On_Bumped_Actor_We_Previously_Ignored;           // (CPF_Parm, CPF_OutParm, CPF_ZeroConstructor, CPF_IsPlainOldData)
};
...
{
	struct FString                                     CallerDebugString;                                        // (CPF_Parm, CPF_ZeroConstructor)
};
